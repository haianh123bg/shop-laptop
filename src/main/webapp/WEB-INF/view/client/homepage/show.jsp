                                            ...
                                            <div class="fruite-img">
                                                <a href="/product/${product.id}">
                                                    <c:if test="${not empty product.images}">
                                                        <img src="/images/product/${product.images[0].image}" class="img-fluid w-100 rounded-top" alt="">
                                                    </c:if>
                                                    <c:if test="${empty product.images}">
                                                        <img src="/images/default.jpg" class="img-fluid w-100 rounded-top" alt="No Image">
                                                    </c:if>
                                                </a>
                                            </div>
                                            <!-- Phần còn lại của mã -->
